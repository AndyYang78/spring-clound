...
function query() {
    $('#table_main').bootstrapTable('refresh', {url: '/content/chatroom/report/list'});
}
...
window.operateEvents = {
    ...
    'click .complete': function (e, value, row) {
        $.post('/content/chatroom/report/complete', {id: value}, function (response) {
            if (response.success) {
                query();
    ...
    'click .remove': function (e, value, row) {
        $.post('/content/chatroom/report/remove', {id: value}, function (response) {
            if (response.success) {
                query();
